...
| `Alt` + `Arrow Left`     | `Cmd` + `Arrow Left`     | Forward in browsing history |
...
| `Shift` + `F4`                                 | `Shift` + `F4`                                 | Open Source in New Window                     |
...
| `Shift` + `Alt` + `Arrow Down`                 | `Option` + `Shift` + `Arrow Down`              | Move Line Down                                |
